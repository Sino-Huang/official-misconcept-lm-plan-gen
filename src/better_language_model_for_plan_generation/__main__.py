"""better-language-model-for-plan-generation file for ensuring the package is executable
as `better-language-model-for-plan-generation` and `python -m better_language_model_for_plan_generation`
"""
import importlib
