...
def get_reward(reward_function, response_text_lst, domains, instance_ids, prompt_ids, raw_plans, torch_type, torch_device):
    # TODO SUKAI implement this function
...
class CustomRewardPPOv2Trainer(Trainer):
    _tag_names = ["trl", "ppo"]
    ...
    def train(self):
        ...
        for update in range(1, args.num_total_batches + 1):
            ...
            if self.control.should_save:
                ...
                self.save_model(output_dir=self.args.output_dir, _internal_call=True)
